...
from shared import dark_theme_background
...
class ScrollBar(tk.Canvas):
    def __init__(self, master, *args, **kwargs):
        self._scroll_kwargs = {'command': None,
                               ...
                               'buttontype': 'round',
                               'buttoncolor': '#4ca6ff',
                               'troughcolor': dark_theme_background,
                               'thumbtype': 'rectangle',
                               'thumbcolor': '#4ca6ff',
                               }
...
if __name__ == '__main__':
    ...
    sbx1 = MyScrollbar(root, height=50, command=lb.xview, orient='horizontal', buttoncolor='red', thumbcolor='orange',
                       troughcolor='green')
